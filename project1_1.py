...
# User input
user_input = input("Enter your consumption in W: ")
...
print(f"Total number of inverters available: {len(inverters)}\n")

# Calculate the suitable panel size and number of panels
p1 = conso / 1600
if p1 > 4:
...
print(f"Number of panels required: {number_panels}")
print(f"Total power from panels: {p_f}W\n")

# Function to find suitable inverters
...
# Print suitable inverters
print("Suitable Inverters:")
print("-------------------")
for inverter, specs in suitable_inverters:
    print(f"Inverter Model: {inverter}")
    for key, value in specs.items():
        print(f"  {key}: {value}")
    print()

if not suitable_inverters:
    print("No suitable inverters found.")
