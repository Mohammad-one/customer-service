...
main_frame = tk.Frame(root, padx=20, pady=20, bg='#FFFFFF')  # Light background
main_frame.pack(fill=tk.BOTH, expand=True)

# Header label
header_label = tk.Label(main_frame, text="Solar Inverter Selector", font=("Arial", 20), bg='#FFFFFF')  # White background
header_label.pack(pady=(0, 20))

# Client name input
client_frame = tk.Frame(main_frame, bg='#FFFFFF')  # White background
client_frame.pack()

label_client_name = tk.Label(client_frame, text="Client Name:", font=("Arial", 12), bg='#FFFFFF')
...
# Input frame
input_frame = tk.Frame(main_frame, bg='#FFFFFF')  # White background
input_frame.pack()

label_consumption = tk.Label(input_frame, text="Enter your consumption in W:", font=("Arial", 12), bg='#FFFFFF')  # White background
...
# Results frame
results_frame = tk.Frame(main_frame, bg='#FFFFFF')  # White background
...
# Buttons frame
buttons_frame = tk.Frame(main_frame, bg='#FFFFFF')  # White background
